...
public class updatebookservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			int book_id=new addbookDao().updatebook(book_title,author,edition,publisher,isbn,pages,mrp,categorys,description,publish_year,book_language,modified_on,id,user_id,count);
