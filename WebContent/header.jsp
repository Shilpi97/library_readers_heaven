                                    ...
                                    <div class="col-lg-6 col-md-5 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="dashboard.jsp" class="nav-link">Home</a>
                                                </li>
                                                
                                                <li class="nav-item"><a href="viewbook.jsp" class="nav-link">Book</a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                      ...
                                                      <!--   <li><a href="lock.html"><span class="fa fa-diamond author-log-ic"></span> Lock</a>
                                                        ...
                                                        <li><a href="./logoutServlet"><span class="fa fa-sign-out author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                                                        </ul>
