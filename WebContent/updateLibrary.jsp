                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                        <div class="form-select-list">
                                                                            <input type="text" class="form-control basic-ele-mg-b-10" placeholder="Pincode" name="pincode"  title="only 6 digits" pattern="[0-9]{6} value="<%=book.getPincode() %>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                        <div class="form-select-list">
                                                                    ...
                                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                        <div class="form-select-list">
                                                                            <input type="text" class="form-control" placeholder="Enter Mobile No." name="mobile_no" title="only 10 digits" pattern="[0-9]{10} value="<%=book.getContact_no() %>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
