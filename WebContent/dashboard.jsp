                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>Monthly Sale</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                    ...
                    <% 
                        ...
                        <div class="white-box analytics-info-cs mg-b-10 res-mg-t-30">
                            ...
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right sp-cn-r"><i class="fa fa-level-up" aria-hidden="true"></i> <span class="counter text-success"><%= book.getTotal_book() %></span></li>
                            </ul>
                        </div>
                        <div class="white-box analytics-info-cs mg-b-10">
                            <h3 class="box-title">New added Book</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                                    <div id="sparklinedash2"></div>
                                </li>
                                <li class="text-right"><i class="fa fa-level-up" aria-hidden="true"></i> <span class="counter text-purple"><%= book.getNew_arrival() %></span></li>
                            </ul>
                        </div>
